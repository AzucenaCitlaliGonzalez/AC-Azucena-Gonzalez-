...
# ╔═╡ 4ce077f4-3d15-483e-8fc3-c42bb2744992
Michinariz = michi[174:286, 191:322]
...
# ╔═╡ f55c5183-8a39-4d60-bb36-ee955a968782
arte_de_pixeles = [RGB{Float64}(0.78, 0.89, 1.0) RGB{Float64}(0.78, 0.08, 0.52) RGB{Float64}(0.78, 0.08, 0.52) RGB{Float64}(0.78, 0.08, 0.52) RGB{Float64}(0.78, 0.08, 0.52) RGB{Float64}(1.0, 0.68, 0.73) RGB{Float64}(0.78, 0.89, 1.0) RGB{Float64}(0.78, 0.89, 1.0);
RGB{Float64}(0.78, 0.08, 0.52) RGB{Float64}(0.0, 0.0, 0.0) RGB{Float64}(0.78, 0.08, 0.52) RGB{Float64}(0.0, 0.0, 0.0) RGB{Float64}(0.78, 0.08, 0.52) RGB{Float64}(0.78, 0.89, 1.0) RGB{Float64}(0.78, 0.89, 1.0) RGB{Float64}(0.78, 0.89, 1.0);
RGB{Float64}(0.78, 0.08, 0.52) RGB{Float64}(0.78, 0.08, 0.52) RGB{Float64}(0.78, 0.08, 0.52) RGB{Float64}(0.78, 0.08, 0.52) RGB{Float64}(0.78, 0.08, 0.52) RGB{Float64}(1.0, 0.68, 0.73) RGB{Float64}(0.78, 0.89, 1.0) RGB{Float64}(0.78, 0.89, 1.0);
RGB{Float64}(0.78, 0.89, 1.0) RGB{Float64}(0.78, 0.89, 1.0) RGB{Float64}(1.0, 0.68, 0.73) RGB{Float64}(1.0, 0.68, 0.73) RGB{Float64}(0.78, 0.08, 0.52) RGB{Float64}(0.78, 0.89, 1.0) RGB{Float64}(0.78, 0.89, 1.0) RGB{Float64}(0.78, 0.89, 1.0);
RGB{Float64}(0.78, 0.89, 1.0) RGB{Float64}(0.78, 0.08, 0.52) RGB{Float64}(1.0, 0.68, 0.73) RGB{Float64}(0.78, 0.08, 0.52) RGB{Float64}(0.78, 0.08, 0.52) RGB{Float64}(1.0, 0.68, 0.73) RGB{Float64}(0.78, 0.89, 1.0) RGB{Float64}(0.78, 0.89, 1.0);
RGB{Float64}(0.78, 0.89, 1.0) RGB{Float64}(0.78, 0.89, 1.0) RGB{Float64}(1.0, 0.68, 0.73) RGB{Float64}(1.0, 0.68, 0.73) RGB{Float64}(0.78, 0.08, 0.52) RGB{Float64}(0.78, 0.89, 1.0) RGB{Float64}(0.78, 0.89, 1.0) RGB{Float64}(0.78, 0.08, 0.52);
RGB{Float64}(0.78, 0.89, 1.0) RGB{Float64}(0.78, 0.89, 1.0) RGB{Float64}(1.0, 0.68, 0.73) RGB{Float64}(1.0, 0.68, 0.73) RGB{Float64}(0.78, 0.08, 0.52) RGB{Float64}(0.78, 0.08, 0.52) RGB{Float64}(0.78, 0.08, 0.52) RGB{Float64}(0.78, 0.89, 1.0);
RGB{Float64}(0.75509,0.965058,0.65486) RGB{Float64}(0.75509,0.965058,0.65486) RGB{Float64}(0.78, 0.08, 0.52) RGB{Float64}(0.75509,0.965058,0.65486) RGB{Float64}(0.78, 0.08, 0.52) RGB{Float64}(0.75509,0.965058,0.65486) RGB{Float64}(0.75509,0.965058,0.65486) RGB{Float64}(0.75509,0.965058,0.65486)]
